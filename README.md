...
<table>
  ...
  <td>
    <h3>Ця програма демонструє роботу 4 прямокутників <br>які змінюються за розмірами та над кожним з них <br>є їхні площі. Знизу продемонстровано загальну площу та <br>зображено кнопки «Start» - для старту потоку <br>та «Clear» - для зупинки потоку.</h3>
  </td>
</table>
