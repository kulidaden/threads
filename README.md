...
<table>
  ...
  <td>
    <h3>Ця програма демонструє роботу 4 прямокутників <br>
      ...
      є їхні площі. Кожен прямокутник це поток, загальна площа теж окремий поток. Знизу продемонстровано загальну площу та <br>
      зображено кнопки «Start» - для старту потоку <br>
      та «Clear» - для зупинки потоку. За допомогою цих кнопок можна керувати потоками.></h3>
  </td>
</table>
